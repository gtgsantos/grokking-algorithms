...
test(`should return true for object with same name at level 3`, () => {
    ...
    expect(checkIfTheresRepeatedNames({ name: "iphone", weight: 1, price: 2000, link: 
                                { name: "stereo", weight: 4, price: 3000, link:
                                    { name: "guitar", weight: 1, price: 1500, link: undefined }
                                }
                            }, { name: "lighter", weight: 1, price: 50, 
                            link:{ name: "guitar", weight: 1, price: 1500, link: undefined }})).toBe(true)
...
different values`, () => {
   ...
   var expectedLvl2 = new Map()    
   expectedLvl2.set(1, { name: "guitar", weight: 1, price: 1500, link: undefined })
   expectedLvl2.set(2, { name: "guitar", weight: 1, price: 1500, link: undefined })
   expectedLvl2.set(3, { name: "guitar", weight: 1, price: 1500, link: undefined })
   expectedLvl2.set(4, { name: "stereo", weight: 4, price: 3000, link: undefined })
   
   expected.set(2, expectedLvl2)

   var expectedLvl3 = new Map()    
   expectedLvl3.set(1, { name: "guitar", weight: 1, price: 1500, link: undefined })
   expectedLvl3.set(2, { name: "guitar", weight: 1, price: 1500, link: undefined })
   expectedLvl3.set(3, { name: "laptop", weight: 3, price: 2000, link: undefined })
   expectedLvl3.set(4, { name: "laptop", weight: 3, price: 2000, link: { name: "guitar", weight: 1, price: 1500, link: undefined } })

   expected.set(3, expectedLvl3)

   var expectedLvl4 = new Map()    
   expectedLvl4.set(1, { name: "iphone", weight: 1, price: 2000, link: undefined })
   expectedLvl4.set(2, { name: "iphone", weight: 1, price: 2000, link: { name: "guitar", weight: 1, price: 1500, link:undefined }})
   expectedLvl4.set(3, { name: "iphone", weight: 1, price: 2000, link: { name: "guitar", weight: 1, price: 1500, link:undefined }})   
